...
const uint8_t index_html_gz[] = {
  ...
  ,
...
void ajoutOSD(fb_data_t *rgbfb) {
  ...
  /*
  // suppression vert et bleu
  for(int i=0; i<rgbfb->width*rgbfb->height*3; i+=3) {
    rgbfb->data[i]=32;
    rgbfb->data[i+1]=32;
  }
  */
  ...
  for(int x=ESPX; x<=(rgbfb->width)-ESPX; x+=ESPX) {
    ...
    fb_gfx_fillRect(rgbfb, x-1, 0, 2, (rgbfb->height)-1, COLOR_RED);
  }
  for(int y=ESPY; y<=(rgbfb->height)-ESPY; y+=ESPY) {
    // trace ligne horizontale
    fb_gfx_fillRect(rgbfb, 0, y-1, (rgbfb->width)-1, 2, COLOR_RED);
  }
  */
...
void setup() {
  ...
  digitalWrite(4, HIGH); delay(50); digitalWrite(4, LOW);
}
